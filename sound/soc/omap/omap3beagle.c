...
static int __init omap3beagle_soc_init(void)
{
	...
	if (machine_is_omap3530_lv_som() || machine_is_omap3_torpedo()) {
		pr_info("OMAP3 Logic SoC init\n");
		snd_soc_omap3beagle.name = "omap3logic";
	} else if (machine_is_omap3_beagle()) {
		pr_info("OMAP3 Beagle init\n");
	} else {
		pr_debug("Not OMAP3 Beagle or OMAP3 Logic board!\n");
		return -ENODEV;
	}
