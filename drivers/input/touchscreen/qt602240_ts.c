...
struct key keypad[] = {
	{845,960,  10,151, 1,0,KEY_BACK,'B'}, 		/* BACK key */
	{845,960, 152,324, 1,0,KEY_HOME,'H'},	/* HOME key */
	{845,960, 325,469, 1,0,KEY_MENU,'M'},	/* MENU key */

	{961,1027,  10,151, 1,0,KEY_1,'1'}, 		/* 1 key */
	{961,1027, 152,324, 1,0,KEY_2,'2'},		/* 2 key */
	{961,1027, 325,469, 1,0,KEY_3,'3'},		/* 3 key */

	{1028,1094,  10,151, 1,0,KEY_4,'4'}, 		/* 4 key */
	{1028,1094, 152,324, 1,0,KEY_5,'5'},		/* 5 key */
	{1028,1094, 325,469, 1,0,KEY_6,'6'},		/* 6 key */

	{1095,1165,  10,151, 1,0,KEY_7,'7'},		/* 7 key */
	{1095,1165, 152,324, 1,0,KEY_8,'8'},		/* 8 key */
	{1095,1165, 325,469, 1,0,KEY_9,'9'},		/* 9 key */

	{1166,1235,  10,151, 1,0,KEY_NUMERIC_STAR,'*'},/* * key */
	{1166,1235, 152,324, 1,0,KEY_0,'0'},			/* 0 key */
	{1166,1235, 325,469, 1,0,KEY_NUMERIC_POUND,'#'},	/* # key*/
