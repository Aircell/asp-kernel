 ...
 * Isochronous Transfer support code file
 *
        ...
        )
{
    ...
    buff_dma = (dma_addr_t) ((unsigned char *)urb->transfer_buffer + offset);
        ...
        )
{
    ...
    while(1)
    {
        ...
        next_itd = (struct ehci_itd *) (itd->hw_next);
