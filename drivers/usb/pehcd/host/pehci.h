...
#define BLK_8192_                       4  /*32K*/
#define BLK_TOTAL                       (BLK_256_ + BLK_1024_ + BLK_8192_)
...
#define PORT_RWC_BITS   (PORT_CSC | PORT_PEC | PORT_OCC) //ly
...
#define MAX_PTD_BUFFER_SIZE             8192 /*max ptd size*/
