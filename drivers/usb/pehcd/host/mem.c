/************************************************************
 * SP176x Linux Host Controller driver : pehcd
 * Memory management code file
 *
...
phci_hcd_mem_init (void)
{
    ...
    for(i=(BLK_256_ + BLK_1024_);i<(BLK_256_ + BLK_1024_+BLK_8192_);i++){
        memaddr = &memalloc[i];
        memaddr->blk_num = i;
        ...
        u32 flag)
{
    ...
    /*end of the 8k blocks*/
    nextblk4 = nextblk1 +  BLK_8192_;
