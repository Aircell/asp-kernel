 ...
 * Hardware Access Interface header file
 *
...
#if ((defined LINUX_269) || defined (LINUX_2611))
int     isp1761_request_irq(void(*handler)(struct isp1761_dev* dev,void* isr_data, struct pt_regs* regs),
