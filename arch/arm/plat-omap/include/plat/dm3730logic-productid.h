...
#ifndef DM3730LOGIC_PRODUCTID_H
#define DM3730LOGIC_PRODUCTID_H
...
extern int dm3730logic_get_product_id_part_number(u32 *part_number);

extern int dm3730logic_extract_lan_ethaddr(u8 *ethaddr);
extern int dm3730logic_extract_wifi_ethaddr(u8 *ethaddr);
extern void dm3730logic_fetch_sram_product_id_data(void);
int dm3730logic_extract_product_id_part_number(struct product_id_data *p, char *buf, int buflen);
extern int dm3730logic_extract_serial_number(struct product_id_data *p, char *buf, int buflen);

extern int dm3730logic_external_mute_gpio(void);

extern void dm3730logic_set_product_id_data(struct product_id_data *p);

extern int dm3730logic_NOR0_size(void);
extern int dm3730logic_NAND0_size(void);

extern int dm3730logic_has_wilink_wifi_module(void);
extern int dm3730logic_has_isp176x(void);
#endif
