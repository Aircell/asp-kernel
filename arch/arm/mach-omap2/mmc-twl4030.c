 ...
 * populating embedded_sdio_data structure in mmc-tlw4030 by:
...
static struct sdio_cis omap_wifi_emb_cis = {
...
static struct sdio_cccr omap_wifi_emb_cccr = {
	.multi_block = 1,
	.low_speed = 0,
	.wide_bus = 1,
	.high_power = 0,
...
static struct embedded_sdio_data omap_murata_wifi_emb_data = {
	.cis = &omap_wifi_emb_cis,
	.cccr = &omap_wifi_emb_cccr,
...
#endif
#ifdef CONFIG_MACH_OMAP3530_LV_SOM
/* WiFi data for uf1050a */
static struct embedded_sdio_data omap_uf1050a_wifi_emb_data = {

	.quirks = MMC_QUIRK_CARD_SUPPORTS_VDD_165_195,
};
#endif
#endif
...
void __init twl4030_mmc_init(struct twl4030_hsmmc_info *controllers)
{
	...
	for (c = controllers; c->mmc; c++) {
		...
		if (c->mmc == CONFIG_TIWLAN_MMC_CONTROLLER) {
			struct embedded_sdio_data *emb_data = NULL;
#ifdef CONFIG_TIWLAN_SDIO
